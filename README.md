...
[![Version](https://img.shields.io/badge/Version-1.2.3-success?style=for-the-badge)](#-versioning)
...
Semantic Versioning 2.0. The single source of truth is `app/__init__.py::__version__ = "1.2.1"`. It is read by:
